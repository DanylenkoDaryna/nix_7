...
public class BookShelfDb{
    ...
    private static final BookShelfDb instanceDB = new BookShelfDb();
    ...
    public static BookShelfDb getDbInstance(){
        return instanceDB;
    }
    ...
    public Book readBook(long idToFind){
    ...
    public void deleteBook(long idToDelete){
        for(int i = 0; i < bookShelf.size(); i++){
    ...
    public Author readAuthor(long idToFind){
        for(int i = 0; i < authorCatalogue.size(); i++){
            Author tempAuthor = (Author) authorCatalogue.get(i);
    ...
    public void deleteAuthor(long idToDelete){
        for(int i = 0; i < authorCatalogue.size(); i++){
            Author tempAuthor = (Author) authorCatalogue.get(i);
